...
Опорная геометрия - координатная базовая плоскость.Их можно создать сколь угодно множество опорных геометрий.

![рис_73](./nx_img/рис_73.png)

Есть абсолютная система координат - это неподвижная система координат, находящаяся в центре модельного прространства, которая орпеделяет координаты всех геометрических объектов модели. Она явно никак не отображаеться !

Относительная система координат (РСК) - это подвижная система координат, перемещаемая куда угодно, которая также определяет координаты геометрических объектов модели. Явно отображаеться! w - включить или выключить отображение

![рис_74](./nx_img/рис_74.png)

Можем видеть растояние относительно абсолютной системы координат

![рис_75](./nx_img/рис_75.png)

Другое построение блока - как модель
