...
1. В рамках опросов об использовании товаров или услуг. Например, можно задать пользователям вопросы об их любимом бренде молока и как часто они его покупают.
2. Используя открытую статистику по числу покупателей товаров или услуг. Например, можно найти информацию о количестве автомобилей, зарегистрированных в том или ином регионе и таким образом оценить потенциал рынка автошин.
...
- Спрогнозировали состояние рынка компании для четырёх возможных вариантов развития будущего / **Шаг 3. Разработка наиболее вероятных сценариев**
...
## Ключевые принципы дизайна цифровых продуктов

В первом уроке мы:
- разберём вопросы, которые возникают в начале проработки идеи;
- определим десять принципов хорошего дизайна цифровых продуктов;
- познакомимся с понятием дизайн-системы.

Команда Melody продолжает работу над новой фичей. Макс переживает, что детский режим не спасёт положение любимой компании. Поэтому он решил попробовать самостоятельно найти слабые точки и проработать их. Поскольку Макс знает, как проводить исследование конкурентов, он решил начать именно с него.

### От идеи к решению

Изначально идея продукта сформулирована лишь на словах и в общих чертах. Мы знаем, какую потребность пользователя мы закрываем и какую фичу хотим для этого разработать. У нас есть предположение, как она повлияет на бизнес-метрики.

Пришло время решить, как именно будет выглядеть фича.

Вариантов реализации одной и той же задачи есть очень много. На конкурентном рынке от выбранного способа зависят ключевые метрики продукта или даже его судьба.

Например, мы хотим создать сервис покупки билетов в театр. Чтобы понять, как будет выглядеть конечный продукт, нужно ответить на ряд вопросов, в том числе:
- Это будет витрина из популярных спектаклей, список театров с их афишами или чат-бот, подбирающий постановку по интересам?
- Решение будет одинаковым для мобильного приложения и сайта?
- Как упаковать постеры? Один крупный и цепляющий на весь экран — или много маленьких?
- Какой театр будет выше на странице: у которого больше продаж или который платит нам бо́льшую комиссию?
- Где разместить кнопку для покупки? Что на ней написать?
- Какими словами и с каким настроением сервис будет общаться с пользователем?

Чтобы ответить на эти вопросы, в продуктовых командах продакт-менеджер и дизайнер работают вместе. Подробно про взаимодействие с дизайнером мы поговорим в одном из следующих уроков.

А пока давай обсудим, на что опираться при проработке решения.

### Хороший дизайн цифрового продукта

Мы возьмём за основу десять принципов хорошего дизайна, сформулированных промышленным дизайнером Дитером Рамсом. Принципами Рамса вдохновлялись дизайнеры Apple; эти положения до сих пор на слуху в IT-индустрии.

Десять принципов более актуальны для дизайнеров, поскольку они отвечают за внешний вид продукта. Но и продакт-менеджеру полезно знать и понимать эти принципы. Это поможет ей или ему увидеть полную картину дизайна продукта и выстроить качественное общение с командой.

Сперва мы рассмотрим семь принципов, которые связаны с бизнес-составляющей продукта. Они требуют особого внимания продакт-менеджера.

### Принцип 1. Хороший дизайн делает продукт полезным

«Продукт покупают, чтобы им пользоваться. Хороший дизайн подчеркивает полезность продукта и не отвлекает от неё» (эта и другие цитаты в кавычках, приведённые ниже, взяты из книги «Дитер Рамс: Десять принципов хорошего дизайна»).
- Продумывай структуру продукта так, чтобы ключевые целевые действия выполнялись за минимальное число шагов. Убирай препятствия. Вспомни свои чувства, когда во время решения важной и срочной задачи, вылезает рекламный баннер на весь экран!
- Уделяй особое внимание визуальным акцентам на экране. Что первое бросается в глаза? На каждом шаге пути пользователя нужно выделять элементы, которые приведут её или его к цели.
- Следи за текстом. Это важная часть дизайна продукта. Транслируй его ключевые посылы дизайнерам и копирайтерам. Кто, как не продакт, сможет хорошо облечь ценность продукта в слова!

### Принцип 2. Хороший дизайн делает продукт понятным

«Продукт должен быть интуитивно понятным в использовании».
- Уделяй внимание онбордингу — обучению новых пользователей. Вспомни, как пользователя «ведут за ручку» в любой игре на смартфоне — это стоит взять на вооружение. Отличный пример — сервис для совместной работы Miro. Онбординг там реализован в разных форматах: от всплывающих подсказок до видеороликов и готовых шаблонов проектов.
- Лучше использовать привычные элементы управления и шаблоны поведения интерфейса. Так пользователи быстрее сориентируются в твоём продукте. Присмотрись к дизайну популярных продуктов: соцсетей, мессенджеров и почтовых клиентов.
- Выбирай за пользователя, когда это можно сделать. Не все хотят разбираться в нюансах. Заранее подумай за пользователей и упрости им жизнь. Вспомни, что при установке программы на компьютер обычно есть варианты «По умолчанию» и «Расширенные настройки». Удобно, не правда ли?
- Сделай call to action понятным. Текст должен чётко объяснять, что произойдёт после действия пользователя. Например, вместо «Загрузить» лучше написать «Получить бесплатную книгу», вместо «Подписаться» — «Попробовать 30 дней бесплатно».
- Сохраняй единую терминологию во всем продукте: не называй одно и то же разными именами.
- Собирай обратную связь от пользователей. То, что очевидно продакту и дизайнеру, необязательно будет ясно пользователю. Лучший способ проверить — спросить. О тестировании дизайн-решений мы поговорим в следующих уроках.

### Принцип 3. Хороший дизайн продуман до мелочей

«Ничего не оставляйте на волю случая. Точность и аккуратность в дизайне показывают уважение к пользователю».
- Сними барьеры на пути к главной цели. Не вынуждай пользователя делать одно и то же по несколько раз. Например, добавь авторизацию через соцсети, предложи сохранить данные для входа, номер карты для оплаты или адрес доставки.
- Продумай корнер-кейсы, в которых пользователь отклоняется от основного успешного сценария или что-то идёт не так. Подготовь понятные тексты ошибок с конкретными рекомендациями. Например, выведи кнопку для пополнения счёта, когда не хватает денег для оплаты; заготовь аватарку на период, пока пользователь не загрузил свою фотографию; дай ссылку для повторной отправки SMS, если оно не получено.
Продумай, как приложение будет вести себя без интернета. Оно перестанет работать или переключится на упрощённый функционал? - Подумай, можно ли подготовить к этому пользователя заранее: например, скачать плейлисты или загрузить карты в навигатор.
Подумай над универсальностью. Какие у твоего продукта сегменты целевой аудитории? Нужна ли персонализация? Нужно ли переводить на разные языки? Возможно, стоит добавить увеличенный шрифт для людей с нарушениями зрения? Примеры: переключение языка интерфейса в Telegram, детский профиль на «Кинопоиске».

### Принцип 4. Хороший дизайн — инновационный

«Развитие технологий всегда предоставляет возможности для инноваций. Инновационный дизайн идет об руку с технологией».

Подумай, какие технологии вы с командой можете использовать в своем продукте. Голосовое управление освобождает руки. QR-коды упрощают оплату. Машинное обучение распознаёт болезни у растений и рекомендует для них лекарство в приложении. Face ID облегчает авторизацию.

### Принцип 5. Хороший дизайн честен

«Дизайн сам по себе не сделает продукт более инновационным или ценным, чем он есть на самом деле. Не вводите пользователя в заблуждение и не обещайте ему того, что не сможете выполнить».
- Создавай реалистичные ожидания. Например, если поддержка не может ответить на любое сообщение за 30 минут, назови реальный срок.
- Пиши об условиях честно крупным шрифтом, не прячь важную информацию в сносках со звёздочками.
- Не выбирай платные услуги за пользователя. Это неправильно.

### Принцип 6. Хороший дизайн — это как можно меньше дизайна

«Меньше, но лучше. Концентрируйтесь на главных задачах продукта и не перегружайте его множеством дополнительных функций».

Отказывайся от неудачных фич. Так ты упростишь жизнь пользователям, а также избавишь разработчиков и тестировщиков от необходимости поддерживать код.

### Принцип 7. Хороший дизайн экологичен

«Дизайн вносит важный вклад в сохранение окружающей среды. Он должен экономить ресурсы и минимизировать как физическое, так и визуальное загрязнение».

Принцип экологичности относится к офлайн-продуктам и промышленному дизайну, а также важен на стыке офлайна и онлайна. Например, можно отказаться от бумажных чеков в пользу электронных.
Макс
Все принципы записал, постараюсь запомнить!

### Принцип 8. Хороший дизайн эстетичен

«Эстетичность продукта — неотъемлемая часть его полезности, потому что вещи, которые мы используем каждый день, влияют на нашу личность и самочувствие. Только хорошо сделанные объекты могут быть красивыми».

### Принцип 9. Хороший дизайн ненавязчив

«Продукты — это не декоративные объекты и не произведения искусства, они выполняют роль инструмента. Поэтому их дизайн должен быть нейтральным и сдержанным и оставлять пространство для самовыражения пользователей».

### Принцип 10. Хороший дизайн долговечен

«Не гонитесь за модой и трендами, и ваш дизайн не устареет. Однако стоит разделять временные вспышки трендов и меняющиеся со временем паттерны поведения пользователей. Например, отказ от звонков в пользу чатов».

### Задание

Какие из принципов хорошего дизайна продакт-менеджеры нарушили в ситуациях ниже?
- Продакт-менеджер онлайн-банка придумал игру к 8 марта и поставил её на место блока с балансом счёта клиента на главной странице / **Полезность** / Это решение противоречит принципу полезности: помогать продукту решать свою главную задачу.
Пользователи привыкают к навигации, и её изменение (особенно на время) может сильно их возмутить. Если изменение критически необходимо, нужно помочь пользователям сориентироваться и рассказать, где искать потерявшийся раздел.
- На разных разделах сайта одна и та же платная услуга называется по-разному / **Понятность** / Тут нарушен принцип понятности. Пользователю важно знать, за что он платит. Разные названия одной и той же услуги путают пользователя. 
Эта ошибка чревата жалобами в поддержку и негативом в соцсетях. Также это несёт риски для команды продукта: со временем она может забыть про разделы сайта или инструкцию для пользователей, в которых услуга называется иначе.
- Клиент изменил номер телефона и потерял доступ к приложению. Единственный способ авторизации — через SMS-код на телефон / **Продуманность до мелочей** / Сервис явно не продуман до мелочей. Лучше заранее просчитать сценарии, когда что-то идёт не так.Оставь для пользователя обходные пути, особенно когда речь идет о таком важном процессе, как вход в приложение. В крайнем случае можно просто вывести на экран контакты техподдержки.
- Приложение для брони салонов красоты просит пользователя ввести ближайшую станцию метро / **Инновационность** / Решение явно устарело и не соответствует критерию инновационности. Стандарт индустрии — геолокация по GPS.
- В сервисе заметок пользователь не может форматировать текст. Зато есть фичи, чтобы распознать чек по фотографии, создать пользовательский шрифт или выбрать фон для заметки / **Полезность** /  Когда выбираешь приоритеты, помни о принципе «Меньше, но лучше».Можно добавить технологичные фичи, которые будут хорошо смотреться в пресс-релизе. Но если твоё приложение плохо решает ключевую задачу, пользователи в нём надолго не задержатся.
- При покупке авиабилета галочка в чекбоксе «Купить страховку» поставлена по умолчанию / **Честность** / Это нечестно по отношению к пользователям.Многие заметят, что сайт выбрал платную услугу за них, и в следующий раз пойдут к конкурентам. Кто-то может написать об этом в соцсетях или даже подать на компанию в суд.

### Дизайн в крупных компаниях

**Принципы**

Крупные компании часто вырабатывают свой набор принципов дизайна, исходя из своего видения, экспертизы и целей по восприятию бренда. Их легко найти в открытых источниках. Вот пара примеров.

В разгар пандемии коронавируса платформа для аренды жилья Airbnb помогала врачам найти место, чтобы переночевать после долгих смен. Тогда компания сформулировала пять принципов дизайна продукта во время кризисов. Например: «Безопасность. Приоритизируем и защищаем психологическое благополучие».

Pinterest: «Создан для исследования. Это как детская игрушка: ты хочешь пощупать, повертеть её и увидеть, что произойдёт. Чем больше ты исследуешь, чем быстрее ты учишься и тем больше ты получаешь взамен».

Изучение принципов других компаний помогает узнавать об интересных решениях, находить вдохновение и разговаривать с дизайнерами на одном языке.

**Дизайн-система**

Когда компания растёт, в её портфеле появляются несколько продуктов. Над ними работают десятки дизайнеров. Важно сохранять единообразие и проектировать дизайн на основе общих вводных.

Поэтому наряду с принципами дизайна компания вырабатывает собственный набор правил, инструкций и готовых компонентов (например, шаблонов кнопок и других элементов интерфейса). Их можно и нужно использовать в разных продуктах компании. Всё вместе это называется дизайн-системой. 

Например, Apple и Google дают развернутые рекомендации к разработке интерфейсов на их платформах со многими готовыми технологическими решениями. Это позволяет пользователям получать схожий опыт в разных приложениях и упрощает адаптацию к ним. 

При работе с дизайнерами и разработчиками продакт-менеджеру нужно отталкиваться от готовых решений дизайн-системы и существующих ограничений. Если таковых нет, то для начала можно опираться на 10 принципов хорошего дизайна.

### Что ещё почитать и посмотреть

Вот несколько источников, из которых ты можешь почерпнуть больше информации о дизайне продукта.
- Refactoring UI: авторы рассказывают, как создавать красивые интерфейсы, не полагаясь на дизайнера (книга и обучающие видео на английском языке).
- Page Flows — сборник кейсов по онбордингу пользователей от ведущих цифровых продуктов: YouTube, Quora, Spotify и других (текст и видео на английском языке).
- Рекомендации Apple и Google к разработке интерфейсов приложений, которые размещаются на их платформах.

## Проектирование пользовательского опыта

В прошлом уроке мы начали изучать процесс создания дизайна продукта. Мы рассмотрели ключевые принципы, на которые можно в этом опираться.
В этом уроке мы:
- познакомимся с понятиями UX и UI, а также научимся отличать их друг от друга;
- рассмотрим основные стадии проектирования пользовательского опыта.

### UX- и UI-дизайн

При работе над цифровыми продуктами выделяют две области дизайна.
1. UX-дизайн отвечает за то, как работает продукт. Другими словами, какая у него функциональность и логика работы, как пользователь будет с ним взаимодействовать.
2. UI-дизайн отвечает за то, как выглядит продукт. Другими словами, за визуальную составляющую: цвета, картинки, анимацию и вид конкретных элементов.

Например:
- Если мы говорим про набор пунктов меню на сайте, куда каждый из пунктов должен вести и почему — это область UX. Если обсуждаем отступы и шрифты — UI.
- Решение спрашивать ли смс-код при авторизации, — часть UX, нужны ли разделители в номере телефона — UI.
- Когда обсуждаем, нужна ли кнопка на экране для подтверждения заказа, — UX, а если рисуем вид кнопки для конкретного экрана или всех экранов приложения — UI.

В небольших компаниях, как правило, и UX, и UI занимается один и тот же продуктовый дизайнер. Сначала он вместе с тобой продумывает логику (UX), а затем уже отдельно прорабатывает визуал (UI).

В крупных компаниях концентрированная UI-работа происходит в команде дизайн-системы, которая создает UI-компоненты, а продуктовые дизайнеры используют готовые UI-компоненты для решения UX-задач. 

Давай потренируемся отличать эти области дизайна!

### Задание

Какие из дизайн-решений ниже лежат в плоскости UX, а какие в плоскости UI?

UX
- Необходимо разработать блоки, которые будут отображаться на экранах, пока не загружены настоящие элементы (-)
- Решить, как лучше реализовать выбор книги: через подборки по жанрам или через список авторов
- Решить, как лучше указать возраст: строкой ввода, выбором даты в календаре или кнопкой «Мне есть 18»
- Определить, в какой раздел поместить новую услугу

UI
- Сформулировать правила типографики (оформления текстов: шрифты, размер, цвет и начертание букв) в продукте
- Необходимо проработать как выглядит каждая из кнопок при наведении и нажатии.
- Определить желаемую степень затемнения фона при выборе элемента
- Определить палитру цветов

### Этапы проектирования пользовательского опыта

Теперь давай рассмотрим этапы работы над дизайном подробно. За основу мы возьмём классическую модель проектирования пользовательского опыта, разработанную Джесси Гарретом. 

Он выделяет пять этапов работы над пользовательским опытом: от более абстрактного к более конкретному. Обратите внимание, что под пользовательским опытом подразумевается дизайн продукта целиком, включая UX и UI.

![рис_165](./img/165.png)

Давай рассмотрим каждый этап подробно: в разрезе задач продуктовой команды и зон ответственности каждого участника.

### Этап 1. Стратегия

Любой продукт, как и его дизайн, начинается со стратегии. Цель этого этапа — зафиксировать результаты всех предыдущих исследований и чётко сформулировать, какие задачи должен решать продукт и для кого. Для этого тебе нужно:
1. Сформулировать цели бизнеса, дельту ключевых метрик, сроки и ограничения — юридические нюансы, договорённости с партнерами.
2. Собрать артефакты проведённых исследований — карту эмпатии, CJM и другие наработки.
3. Описать задачи и потребности пользователя, которые хотим закрыть фичей или продуктом. Для этого можно использовать фреймворк JTBD или User Story, с которым мы познакомимся в будущих уроках.
4. Поделиться вводными с дизайнером в формате задачи и устного её обсуждения. К этому пункту мы вернёмся в одном из будущих уроков.

За первый этап полностью отвечаешь ты.

### Этап 2. Функциональность

На втором этапе нужно определить, как именно продукт будет решать выбранные задачи пользователя. Конечный результат — список фичей будущего продукта. 

Ты работаешь совместно с дизайнером над следующими задачами.

1. **Погружение в задачи пользователя и их контекст**.

Вот несколько примеров вопросов, на которые будет полезно ответить на этом этапе:
- В какой момент в жизни пользователя возникает эта задача?
- Как они решают эту задачу сейчас? С какого устройства? Какие есть привычки, которые важно учесть?
- С какими проблемами сталкиваются при решении задач? Насколько они серьезны и как часто встречаются?

На часть вопросов ответы даны раньше, при постановке задачи. При поиске ответов на остальные помогут результаты продуктовых исследований: выводы по опросам и глубинным интервью, заполненные фреймворки JTBD, Empathy map, CJM и другие.

2. **Изучение продуктов конкурентов и примеры решения подобных задач в других сферах**.

Вероятно, конкуренты уже прошли подобный путь. Это не означает, что нужно слепо копировать увиденное, но их опыт может натолкнуть тебя на вопрос «Почему сделано именно так?» и подсветить неучтённые сценарии. Скорее всего, пользователи уже привыкли к какому-то стандартному поведению интерфейса в индустрии и игнорировать это будет ошибкой. Ну и наконец, примеры — отличный источник вдохновения. 

3. **Зафиксировать функционал продукта**.

Нужно определить, что пользователь сможет сделать с помощью продукта, а что нет. Например, можно ли будет в приложении для покупки электронных книг вернуть книгу? А подарить? А купить сразу несколько со скидкой? 

На этом этапе важно учитывать потребности как пользователя, так и бизнеса.

### Этап 3. Структура

Основная задача этого этапа — превратить список фичей продукта в конкретные экраны. Дизайнер продумывает, как пользователь будет решать свои задачи. Из этого складывается его путь в продукте, для которого дизайнер создаёт визуальное отображение — **user flow**.  

User flow может выглядеть по-разному: как блок-схема или карта переходов между экранами. Независимо от формы должно быть понятно, откуда и куда может попасть пользователь. То есть через какие экраны и в какой последовательности он будет проходить каждый сценарий.

На этом этапе сами экраны еще не отрисованы, главное сейчас — отобразить сам путь. Нужно убедиться, что пользователь сможет решить обозначенные ранее задачи понятным и удобным способом.

На иллюстрации ниже вы можете увидеть user flow мобильного приложения для аренды игровой консоли и аксессуаров. Подробнее с проектом можно ознакомиться на Бехансе.

![рис_166](./img/166.png)

За создание user flow отвечает дизайнер. Однако продакт-менеджеру стоит вовлечься в этот процесс. Вот несколько рекомендаций:

1. **Сфокусируйся на самом главном для бизнеса сценарии**.

Следи, чтобы user flow не создавал барьеров пользователю при выполнении главной задачи. Например, в приложении для продажи цветов не стоит размещать полный каталог открыток на главном экране. Он будет отвлекать пользователя от выбора букета. Лучше предлагать выбрать открытку в дополнение к цветам.

2. **Думай не только про happy path, но и про корнер-кейсы**.

Что произойдёт, если у клиента при оплате не хватит денег на покупку? Товары пропадут из корзины и его выкинет на главную страницу, или товары останутся в корзине и ему предложат оплатить их другим способом?

Если лимит на покупки по карте израсходован, стоит показать ошибку без деталей или предложить изменить лимит?

Дизайнер может знать не про все ограничения, отдельно заостри на них внимание. Решите, какими фичами вы будете закрывать эти кейсы.

3. **Предусмотри все контексты решения задачи**.

Одна задача может дробиться на несколько маленьких, зависящих от контекста. 

Например, для музыкального приложения возможен сценарий, когда пользователь хочет послушать что-то новенькое, а может быть случай, когда хочется переслушать любимую песню.

На предыдущем шаге вы наверняка решили, что будете закрывать такие задачи разными фичами. Теперь важно сделать так, чтобы пользователь мог легко найти любимую песню и послушать что-то новое. То есть мог решить задачу в разных контекстах.

4. **Имей в виду, что один сценарий может перетекать в другой и обратно**.

На практике сценарии редко жёстко отделены друг от друга, и это нормально. Например, при покупке пользователь может легко уйти пополнять карту. При просмотре сериала он может начать смотреть другой фильм на середине серии, а сезон досмотреть как-нибудь потом. Дай пользователю возможность переключаться с одного сценария на другой с сохранением прогресса.

5. **Смирись с тем, что предусмотреть всё на 100% почти невозможно**.

Однако постарайся учесть самые частые сценарии, которые могут помешать пользователю решить свою главную задачу, а тебе — вырастить метрики.

### Этап 4. Каркас

Целью этого этапа является подготовка прототипа — упрощённой версии продукта, которая демонстрирует его основные функциональные возможности.

Для создания прототипа дизайнер берет за основу user flow из предыдущего этапа. Он продумывает структуру экранов и располагает на них все компоненты: заголовки, кнопки, картинки, данные, которые пользователь должен видеть на экране. 

Как правило, эти компоненты заранее подготовлены дизайнерами на основе дизайн-системы и технических требований и переиспользуются в различных частях продукта. Совокупность таких элементов называют UI-Kit. 

Прототипы бывают разной степени детализации: от набросков на бумаге до детально проработанного варианта с анимацией, который не отличишь от настоящего продукта. Чем более детальный прототип, тем больше времени требуется на его подготовку. 
Подробнее про виды прототипов мы поговорим в следующем уроке.

Работа с прототипом может происходить итерационно. Кому-то из дизайнеров проще сначала рисовать прототип низкой точности, затем постепенно его детализировать. Некоторые дизайнеры после проработки user flow сразу собирают прототип высокой точности из готовых элементов UI-Kit.

На иллюстрации ниже ты можешь увидеть прототипы разной степени точности для мобильного приложения для медитации. С полным проектом дизайна приложения можно ознакомиться на Бехансе.

Созданный прототип отправляется на юзабилити-тестирование с клиентами. В его ходе ты проверяешь, как реальные пользователи взаимодействуют с продуктом и как они его воспринимают. Для большей реалистичности прототип могут сделать интерактивным — с возможностью нажимать на кнопки и имитировать реакцию интерфейса.

После тестирования дизайнер вносит правки в прототип, если нужно. Часть правок можно внести сразу, менее критичные можно отложить на следующие версии продукта. Принимать решение о том, какие правки нужно сделать сейчас, а какие можно отложить, должен продакт-менеджер.

Как только дизайнер создаёт финальную версию прототипа, пора переходить на следующий этап.

### Этап 5. Визуал

На этом этапе дизайнер «наводит красоту» и полностью фокусируется на UI-дизайне: подбирает картинки, выбирает шрифты, прорабатывает анимацию, отдаёт тексты в работу копирайтеру и так далее.

Часть этой работы может быть сделана на предыдущем этапе, на этом этапе важно добить до конца. Готовый дизайн приводится к виду, в котором с ним будет удобно работать разработчикам.

Итог этого этапа и всего процесса проектирования пользовательского опыта — детально проработанный дизайн user flow. После взгляда на финальный прототип ответь на ключевые вопросы:
- Все ли сценарии учтены?
- Верно ли расставлены акценты?
- Сразу ли понятно, куда идти для решения задачи?
- Какие эмоции и ассоциации вызывает продукт?
- Не появилось ли за время отрисовки новых вводных?

### Сводная таблица по этапам проектирование

Мы подготовили таблицу с ключевыми тезисами по всем этапам проектирования пользовательского опыта.

![рис_167](./img/167.png)

### И ещё кое-что

В рамках этого урока мы рассмотрели только один подход к проектированию пользовательского опыта, а в индустрии существуют и другие. Рекомендуем посмотреть на фреймворк «Дизайн-спринт» от Google Ventures, который описывает пошаговую работу над дизайном в течение недели: https://www.thesprintbook.com/.

Важно понимать, что дизайнеры могут использовать разные фреймворки в своей работе.  Описанной выше модели Гаррета не всегда получится строго придерживаться.

Каким бы ни был подход, результат должен быть одинаковым — проработанный и отрисованный user flow.

### Задание

К какому этапу проектирования относится описанная задача?
- Решить, добавлять ли авиабилеты, купленные в приложении на iOS, во встроенный электронный кошелек Wallet / **Этап 2. Функциональность**
- Выбрать картинку для приветственного экрана с учётом новогодней тематики / **Этап 5. Визуал**
- Определить, добавлять ли в приложение такси доставку цветов по праздникам от двери до двери / **Этап 1. Стратегия**
- Решить, куда отправлять пользователя после успешной покупки: на главный экран, в корзину или на предыдущий экран каталога товаров / Этап 4. Каркас / Это задача на проработку логики перехода между экранами. Она **решается на третьем этапе**, при создании первой версии user flow. (-)
- Определить, какие фильтры при поиске для электронных книг будут доступны: по автору, по году выпуска, по жанру, по оценке / **Этап 2. Функциональность**
- Обсудить с дизайнером, какую метрику и на сколько процентов должна улучшить новая фича / **Этап 1. Стратегия**
- Решить, каким будет меню на главном экране: горизонтальным, вертикальным или спрятанным «под тремя точками» / **Этап 3. Структура**
Конкретной компоновкой элементов на экране дизайнер занимается при создании прототипа на четвёртом этапе. (-)

## Виды прототипов по степени детализации

В прошлом уроке мы рассмотрели процесс создания дизайна продукта целиком. Мы упомянули, что прототипы бывают разной степени детализации: от быстрых набросков до тщательно проработанного варианта.

Продакт-менеджеру важно уметь выбирать степень детализации прототипа в зависимости от цели и имеющихся ресурсов. Об этом мы поговорим в текущем уроке.

### Прототипы низкой точности

Прототипы низкой точности, они же эскизы, — это зарисовки интерфейса на скорую руку. Могут быть выполнены на бумаге, в Miro и других подобных инструментах.

Прототипы низкой точности создаются быстро и не требуют специальных умений. Этим инструментом пользуются и дизайнеры, и продакт-менеджеры.

Лоу-фай-прототип пригодится продакту на ранних этапах дизайна продукта, чтобы:
- проработать идею фичи самостоятельно или вместе с дизайнером;
- начать прорабатывать логику работы продукта вместе с командой.

С картинками перед глазами проще думать, обсуждать и видеть важные пользовательские сценарии. 

Вот так, к примеру, выглядит прототип низкой точности у мобильного приложения для медитации, которое мы уже рассматривали в прошлом уроке:

### Прототипы высокой точности

Прототипы высокой точности — это прототипы с полностью проработанной картой экранов и оформленным визуалом. Чаще всего дизайнеры создают их в интерактивном виде при помощи Figma, Framer или Sketch.

Вот для чего подходят такие прототипы.
1. Для тестирования на пользователях одного или нескольких вариантов решения задачи. Об этом мы подробно говорили в уроке про юзабилити-тестирование.
2. Для обсуждения прототипа с командой разработки. В итоге:
- тестировщики могут накинуть идей, какие сценарии важно учесть;
- разработчики оценят варианты с точки зрения трудозатрат;
- вся команда обсудит более простые способы реализации идеи.
3. Для презентации стейкхолдерам. Прототип низкой точности здесь не подойдёт, так как участникам встречи придётся слишком много дорисовывать в своём воображении. Интерактивный прототип высокой точности будет смотреться эффектно. На Zoom-встречах цепляющие визуальные материалы особенно важны.

Главный минус прототипов высокой точности — трудоёмкость. Для экономии времени сперва можно нарисовать детализированный прототип лишь для ключевых сценариев или только для тех, которые будут реализованы в первых версиях продукта. Со временем можно проработать все сценарии и отдать законченный прототип в разработку.

### Прототипы средней точности

Прототипы средней точности (англ. medium-fidelity, или mid-fi), они же схемы (англ. wireframes), — это компромисс между прототипами низкой и высокой точности. В них элементы интерфейса рисуются достаточно реалистично.

Прототипы средней точности используются редко, поскольку большинство потребностей продуктовой команды закрывают два других типа. А именно:
- Когда дизайнер продумывает структуру, навигацию и пользовательские сценарии, можно ограничиться более схематичными рисунками. Обычно хватает прототипа низкой точности.
- Если структура понятна, то экраны легко собираются из уже готовых модулей из UI-Kit. В итоге получается прототип высокой точности, близкий к финальному визуалу продукта. Необязательно рисовать элементы с нуля, когда можно взять существующие.

Впрочем, жёстких правил здесь нет, тебе и дизайнеру решать, когда и каким прототипом пользоваться. Например, бывает, что лоу-фай-прототипа недостаточно для донесения своей мысли до разработчиков. Тогда можно повысить его детализацию и сделать прототип средней точности.

### Хочу больше примеров!

Загляни на Behance — платформу, на которой дизайнеры и иллюстраторы со всего мира выкладывают свои работы.
Там можно найти много проектов с пошаговым описанием процесса дизайна или редизайна. А можно отдельно изучить прототипы.

Ты можешь подробнее изучить примеры, которые мы использовали в уроке.
- Проект дизайна приложения для медитации.
- Проект приложения для аренды консоли. Также можно потапать и поскроллить его интерактивный прототип в Figma (загрузка содержимого может занять время, так что наберись терпения).

### Задание

Выбери тип прототипа, который лучше подходит для решения задачи.

Для простоты мы объединили прототипы низкой и средней точности в единый вариант ответа.
- Ты придумываешь новый сценарий заявки на кредитную карту и хочешь проверить, насколько он понятен. Для этого ты собираешься показать коллегам в офисе два варианта этого сценария / **Высокой точности** / Зачастую то, что очевидно продуктовой команде, оказывается малопонятным другим людям. Поэтому до того, как дизайнер потратит своё время на финализацию прототипа, стоит проверять понятность сценария на тех, кто мало связан с продуктом. Для этого можно собрать прототип низкой или средней точности, а потом протестировать его на случайных коллегах из других команд.
- Ты разрабатываешь новые фичи для CRM-системы. Ты хочешь показать их крупным потенциальным клиентам на отраслевой конференции и собрать обратную связь / **Высокой точности** / 
Для такой важной задачи нужен хай-фай-прототип, желательно интерактивный. Упаковка — это важная часть продукта на продажу.
- Ты придумал новую фичу для повышения retention в интернет-магазине: после оформления заказа предлагать клиенту скидку на следующий. Ты хочешь показать свою идею дизайнеру
/ **Низкой или средней точности** / На этапе идеи лучше набросать прототип низкой точности. Нет смысла делать работу за дизайнера и вкладываться в полноценный прототип, если фича ещё не утверждена.
- Ты хочешь создать раздел с детальным профилем пользователя в личном кабинете. Ты накидываешь идеи, чем его можно наполнить, для будущей проработки / **Низкой или средней точности** / На этапе брейншторма удобнее и быстрее работать с лоу-фай-прототипом. Путь от идеи до финальной версии длинный, не стоит тратить время на хай-фай-прототип черновиков.
- Вы с дизайнером проработали функциональность и структуру приложения. На днях пришла вводная, что релиз сдвинули: теперь он на месяц раньше. Ты хочешь узнать у команды разработки, сколько времени займёт разработка оригинальной версии и не нужно ли отказаться от каких-то фич / **Высокой точности** / Для оценки времени разработки лучше использовать прототип высокой точности, поскольку эскизы позволяют сделать лишь приблизительную оценку. Для экономии времени можно пренебречь интерактивностью и побочными сценариями.



## Инструменты для прототипирования и дизайна

В прошлом уроке мы рассмотрели виды прототипов цифрового продукта по степени детализации.

В этом уроке мы познакомимся с инструментами, которыми пользуются продуктовые команды для создания интерфейсов на этапах от генерации идеи до финального дизайна.

### Полный перечень инструментов

Мы подготовили сводную таблицу инструментов в помощь продакту и дизайнеру на каждом этапе проектирования пользовательского опыта.

![рис_168](./img/168.png)

А теперь давай подробнее рассмотрим несколько инструментов из таблицы.

### Notion

**Notion** — это сервис для создания текстовых документов, списков задач, баз данных, баз знаний и много другого. Подходит для совместной работы.

В Notion легко форматировать текст, менять блоки местами, добавлять картинки, менять представление данных — всё это помогает лучше структурировать мысли. 

Ещё Notion можно использовать, когда нужна отдельная страничка для публикации информации вовне без разработки полноценного сайта. В таком случае можно аккуратно оформить страницу и открыть к ней доступ по ссылке.

### Miro

**Miro** — интерактивная доска для совместной работы. Универсальный инструмент для работы продакт-менеджера с широкими возможностями даже в бесплатной версии.

Инструмент можно использовать для создания user flow и прототипов, проведения брейнштормов и оформления результатов продуктовых исследований.

Среди прочего в Miro есть Wireframe Library — библиотека компонентов интерфейса (кнопки, поля для ввода текста и так далее), из которых можно самостоятельно собирать экраны. Чтобы установить библиотеку, открой её страницу на маркетплейсе библиотек Miro и нажми на кнопку Connect. Теперь ты сможешь найти Wireframe Library в блоке Apps.

Рекомендуем внимательно изучить интерфейс и меню Miro. Например, там можно сгруппировать разные части прототипа в фрейм и в режиме презентации переключаться между этими частями. Это помогает сфокусировать аудиторию на конкретных элементах и может быть полезно в выступлениях перед командой.

Большое преимущество Miro — масса обучающих роликов и инструкций, а также шаблонов почти на все случаи жизни продакта. Есть, например, статья про создание прототипов в Miro.

Единственное неудобство сервиса — интерфейс не переведён на русский. Впрочем, его несложно освоить и без знания других языков.

У Miro есть много аналогов: InVision Freehand, Whimsical, Mural, FigJam и другие. Рассмотрим подробнее первые два сервиса.

### InVision Freehand

**InVision Freehand** — интерактивная доска для совместной работы, менее функциональный аналог Miro.

В сервисе есть готовые шаблоны для создания прототипов. Ищи их в инструменте Insert Template по запросу sketch или wireframe.

Также там можно выбирать готовые элементы интерфейса через инструмент Wireframe (аналог Wireframe Library в Miro).

С помощью инструмента Prototype можно создавать кликабельные хай-фай-прототипы на основе уже отрисованных дизайнерами макетов. Посмотреть демовидео Prototype.

### Whimsical

**Whimsical** — ещё одна интерактивная доска для совместной работы. Она не такая универсальная, как Miro, но хорошо подходит для создания прототипов. Например:

Плюс сервиса — большая библиотека готовых элементов интерфейса, которую не нужно отдельно подгружать.

Выбирай элементы (тексты, кнопки, карты, видео и так далее) и размещай их на шаблоне веб-страницы, экранов разных моделей смартфонов или даже Apple Watch. Демостраница по созданию прототипов.

Есть инструмент для создания схем, в том числе user flow, — Flowcharts. Демостраница Flowcharts.

Помимо досок и прототипов, в сервисе удобно редактировать текстовые документы.

Русский язык не поддерживается.

### Pitch

Мы не будем останавливаться на самых популярных сервисах для созданий презентаций, с которыми, тебе, вероятно, доводилось работать: Keynote, PowerPoint и Google Презентациях.

Если ты хочешь расширить свой арсенал, то есть ещё один полезный инструмент для этих целей — Pitch.

Этот сервис:
- поддерживает совместную работу над презентациями;
- содержит большое количество шаблонов и картинок;
- умеет красиво встраивать графики из Excel;
- позволяет вставлять видео с YouTube;
- позволяет собирать фидбэк во время презентации — комментарии и реакции слушателей.

### FlowMapp

**FlowMapp** — онлайн-инструмент для создания CJM, user flow и карт сайта. Может подойти в случаях, когда нужно продумать структуру продукта.

Возможности сервиса можно оценить на странице демопроекта. Там можно найти всевозможные шаблоны для разных продуктов — например, user flow бронирования номера в отеле.

Есть страницы, посвящённые отдельным функциям:
- как построить user flow;
- как создать карту сайта.
Во FlowMapp нет шаблонов для мобильных приложений — только для десктопа.

### Aaply

**Aaply** — инструмент, предназначенный для создания user flow и прототипов средней точности.

Сервис заточен под дизайн мобильных приложений и поддерживает совместную работу. Страница с обзором функционала Aaply.

### Procreate

**Procreate** — красивое iPad-приложение, в котором легко рисовать скетчи и наброски интерфейсов.

Чтобы получить максимум от сервиса, лучше работать в нём стилусом. Есть возможность копировать уже нарисованные экраны и вносить в них небольшие изменения.

### Инструменты для дизайнеров

Мы коротко рассмотрим инструменты, которыми чаще всего пользуются продуктовые дизайнеры при разработке визуала интерфейса.

Эти сервисы позволяют создавать UI-компоненты и собирать из них готовый дизайн, который можно дальше передать команде разработки.

Сервисы предназначены в первую очередь для дизайна и поддерживают возможности прототипирования в том или ином виде.

**Figma**

Наиболее распространённый инструмент. При работе с дизайнерами ты, скорее всего, будешь часто получать ссылки на Figma. Вот несколько ключевых особенностей.
- Это браузерный инструмент. Его можно использовать с любой операционной системой.
- Поддерживает возможность совместной работы. Например, ты сможешь оставлять дизайнерам комментарии прямо в макетах.
- Попробовать инструмент с некоторыми ограничениями можно бесплатно и без лимита по времени.

**Sketch**

Использовался дизайнерами повсеместно до появления Figma и сейчас является его активным конкурентом. Работает только на MacOS в качестве отдельного приложения.

**Adobe XD**

Упрощённый графический редактор с функционалом, близким к Figma и Sketch. Часто идёт в едином пакете с другими инструментами Adobe.

**Principle**

Платный инструмент для MacOS (бесплатная версия работает 14 дней). В Principle можно создавать интерактивные прототипы и настраивать анимацию.

Позволяет импортировать дизайн из Figma или Sketch. Страница Principle с готовыми прототипами для смартфона и десктопа.

**Маркетплейсы UI-Kit**

Если у твоей команды нет своего UI-Kit, можно купить готовые наборы на маркетплейсах. Содержимое UI-Kit позволит создавать прототипы разной степени детализации.

Например, на маркетплейсе UI8 можно купить готовые наборы элементов для Figma, Sketch и других популярных сервисов. 

### Тем, кто хочет ещё

Чтобы узнать об инструментах для дизайна продуктов больше, можешь посетить сайт базы данных UX Tools.https://uxtools.co/tools/design Там есть обзоры на десятки инструментов со сравнением по цене, доступным платформам, функционалу и другим критериям.

## Взаимодействие с продуктовым дизайнером

Дизайнер — широкое понятие. Графические дизайнеры создают постеры для фильмов. Дизайнеры интерьера продумывают внутренний облик квартир. Промышленные дизайнеры проектируют внешний вид устройств, которыми ты пользуешься ежедневно.

При работе над цифровым продуктом продакт-менеджер чаще всего сталкивается с тремя специальностями дизайнеров: UX/UI-дизайнером, продуктовым дизайнером и коммуникационным дизайнером.

Рассмотрим каждую из них поподробнее.

### UX/UI-дизайнер

UX/UI-дизайнеры занимаются проектированием пользовательского опыта на двух этапах.
1. UX-этап, на котором продумывается логика работы продукта.
2. UI-этап, на котором прорабатывается визуал и продукт приобретает финальный вид.

Часто UX/UI-дизайнеры работают в проектном режиме. Они переключаются с задачи на задачу и могут одновременно взаимодействовать с разными продуктами и заказчиками.

Получается, что они профессионалы в создании интерфейсов с учётом вводных от продакт-менеджера, но несильно погружены в сам продукт. 

Обычно такие дизайнеры активно взаимодействуют с продакт-менеджером и мало взаимодействуют с остальной продуктовой командой.

### Продуктовый дизайнер

Это более широкая роль. Помимо работы над UX и UI, продуктовый дизайнер вовлечён в другие процессы создания и улучшения продукта, а именно:
- знает цели команды и планы по развитию продукта;
- участвует в командных встречах и выступает на них;
- хорошо понимает логику работы продукта;
- знает, как пользователи взаимодействуют с продуктом;
- генерирует гипотезы по улучшению продукта;
- общается с разработчиками и тестировщиками напрямую;
- проводит интервью с клиентами, хорошо понимает их боли и потребности.

Как правило, продуктовый дизайнер долго работает над одним продуктом или линейкой продуктов и глубоко погружён в предметную область.

Если в твоей компании есть выделенный дизайнер на команду — скорее всего, это и есть продуктовый дизайнер. Сейчас это норма для продуктовых компаний. 

Когда ресурсы компании ограничены или в одном продукте мало задач, продуктовый дизайнер может параллельно работать с другими командами.

### Коммуникационный дизайнер

Цель коммуникационного дизайнера — упаковка продукта и работа с брендом. Основным инструментом такого дизайнера является брендбук, в котором описаны правила визуального языка компании. 

Поскольку эти задачи относятся к продуктовому маркетингу, между продакт-менеджером и коммуникационным дизайнером часто есть посредник — маркетолог.

Например, когда запускается новая фича продукта, нужно договориться с командой маркетинга о том, как преподнести её аудитории.

Как только продакт-менеджер и маркетолог утвердят посыл, коммуникационный дизайнер получит задачу на подготовку картинок в социальные сети, рассылки, наружную рекламу, на лендинги и так далее.

### Задание

Определи, какой дизайнер больше подходит под описание.

Продуктовый дизайнер
- Активно взаимодействует не только с продактом, но и с продуктовой командой
- Принимает активное участие в продуктовых улучшениях
- Работает над одним продуктом или линейкой продуктов

Коммуникационный дизайнер
- Готовит изображения для публичных ресурсов по брендбуку
- Работает под руководством маркетолога

UX/UI-дизайнер
- Работает в проектном режиме над улучшением нескольких продуктов одновременно
- Фокусируется на проработке UX- и UI-составляющих продукта

### Как организовать работу с дизайнером?

От правильного взаимодействия с дизайнером зависит то, дизайн какого качества и в какие сроки ты получишь.

Вот как обычно выглядит контекст для обращения к дизайнеру. Ты понимаешь, какую проблему пользователей будет решать твоя фича или продукт. У тебя сформулирована продуктовая гипотеза.

Ты понимаешь, как решение будет выглядеть в общих чертах, а может, даже имеешь наброски черновика на бумажке или в Miro.

Всё это значит, что пора передавать задачу дизайнеру. Работу продакта над задачей по дизайну можно разделить на восемь этапов.
1. Формулирование задачи.
2. Планирование.
3. Уточнение деталей задачи (может быть до планирования).
4. Обсуждение промежуточных результатов один на один.
5. Обсуждение UX-дизайна с командой разработки.
6. Юзабилити-тестирование.
7. Доработки.
8. Приёмка результата.

Опишем их по очереди.

### Этап 1. Формулирование задачи

Первым дело нужно описать задачу. Если задача сформулирована хорошо, дизайнер без труда разберётся, что надо сделать, зачем и в какой срок.

Чаще всего задачи создаются в таск-трекере — системе для управления задач, в которой удобно отслеживать их статус.

Вот что важно указать в задаче.
1. Какую проблему и для кого мы (команда) хотим решить? Почему считаем, что такая проблема существует? Какую гипотезу выдвигаем? По возможности приложи результаты продуктовых исследований по теме.
2. Какую бизнес-цель мы преследуем? На какую метрику работаем и почему это важно? Как это связано с долгосрочными целями команды?
3. Что будет являться результатом решения задачи? Может, это будут несколько концептуальных вариантов решения для дальнейшего обсуждения? Или макет для тестирования на пользователях? Или доработка ранее сделанного макета?
4. В какие сроки нужно сделать дизайн? Насколько жёсткие это сроки с учётом внешних ограничений?
5. Какие технические ограничения и другие вводные точно повлияют на решение задачи? Это могут быть, к примеру, планы по развитию продукта, требования использовать конкретный UI-Kit и тому подобное.
6. Список клиентских сценариев и фич продукта.

Это базовый, но не полный перечень пунктов для описания задачи. В некоторых компаниях у дизайнеров могут быть свои чек-листы того, что они хотят видеть в задаче. Обязательно спроси дизайнера об этом.

Можешь прикрепить свои идеи того, как может выглядеть продукт или фича. 

Стоит помнить, что твой партнёр-дизайнер, скорее всего, разбирается в проработке пользовательского опыта лучше тебя. Тебе как продакту лучше делиться своими мыслями и набросками по визуалу в формате идеи — возможного, но не единственного способа решения задачи. Если загонять дизайнера в узкие рамки «Нарисуй то, что я придумал», это может привести к конфликту вплоть до его ухода из команды.

### Этап 2. Планирование

В разных командах планирование устроено по-разному. 
Если ты работаешь в маленькой компании с ещё не выстроенными процессами и у вас один дизайнер, то, скорее всего, ты просто будешь ставить перед ним задачи по мере выполнения предыдущей. Ставить задачи в таком случае можно устно. 

В более крупных и устоявшихся компаниях процесс планирования обычно организован иначе.

Это может быть регулярная еженедельная встреча, на которой собираются продакты и дизайнеры. На такой встрече они обсуждают прогресс по задачам прошлой недели и выбирают, какие задачи делать на текущей.

К встрече по планированию продакт-менеджеру нужно сделать следующее.
- Успеть сформулировать и описать задачи. Если задач больше одной, нужно расставить приоритеты.
- Показать задачи дизайнеру. Так он сможет задать вопросы, оценить сложность реализации и примерно понять, сколько нужно времени на выполнение. Оценить трудоёмкость задачи лучше перед встречей, а на ней самой уже договориться, что именно и в какой срок будет сделано.

### Этап 3. Уточнение деталей задачи

Если задача объёмная или её описания недостаточно, чтобы сразу брать в работу, нужно провести отдельную встречу. На ней вы устно обсудите детали. Вот на что полезно будет обратить внимание.
- Передай дизайнеру дополнительные вводные. Ответь на все вопросы.
- Вежливо попроси дизайнера пересказать, как он понял задачу. Это поможет избежать недопонимания и сэкономит ресурсы.
- Договоритесь, как часто и в каком формате вы будете обсуждать промежуточные результаты.

Мы рекомендуем проводить такую встречу по всем крупным задачам.

Этап уточнения может идти как после планирования, так и до него — зависит от того, как принято в твоей команде.

### Этап 4. Обсуждение промежуточных результатов один на один

На встрече попроси дизайнера показать результаты выполнения задачи. Это может быть концепт, скетч, прототип высокой точности или что-то ещё. Обсуди возникшие вопросы и проблемы.

Дизайнеру может быть некомфортно делиться чем-то недоработанным. Поэтому важно выстраивать с ним доверительные отношения с самого начала. Это позволит вам взаимодействовать более открыто.

Когда даёшь обратную связь дизайнеру, помни о следующем:
- апеллируй к цели, которая поставлена перед фичей;
- опирайся на факты, старайся избегать вкусовщины;
- воздержись от директивных указаний о том, как именно нужно решать задачу.

Лучше подольше поработать над черновым прототипом, чем потратить несколько недель на детальную проработку, а потом обнаружить, что получилось совсем не то.

Также стоит почаще сверять часы на ранних этапах работы, особенно если ты работаешь с этим дизайнером впервые.

### Этап 5. Обсуждение UX-дизайна с командой разработки

После проработки UX-части будет полезно организовать общую встречу и обсудить дизайн с командой разработки.

На этом этапе могут проявиться неочевидные сценарии и технические ограничения, которые не пришли тебе в голову на этапе постановки задачи. Или какая-то из идей может оказаться слишком сложной и долгой для разработки. 

В таком случае задача продуктовой команды — вместе выработать более простое решение, которое выполнит поставленную задачу.

Скорее всего, на одном полюсе будет идеальный и слишком дорогой для команды вариант, на другом — дешёвый и неудобный. Продуктовой команде нужно найти золотую середину между вариантами с точки зрения удобства пользователя и стоимости разработки.

### Этап 6. Юзабилити-тестирование

Перед тем как отдать дизайн в разработку, стоит показать дизайн реальным пользователям и провести юзабилити-тестирование.

Это опциональный, но очень желательный этап. Он позволит тебе взглянуть на дизайн глазами пользователя и увидеть его недостатки.

Как проводить юзабилити-тестирование, мы рассказали в одноимённом уроке.

### Этап 7. Доведение до финального результата

После обсуждения дизайна с продакт-менеджером и командой, а также тестирования на клиентах появится список правок к дизайну.

Дизайнер вносит эти правки и прорабатывает все детали UI-части. Менее критичные правки можно отложить до следующих версий продукта.

Финальный вариант дизайнер отдаёт на приёмку продакт-менеджеру.

### Этап 8. Приёмка результата

На последнем этапе важно проверить, решена ли поставленная задача, а также:
- Учтены ли все запланированные сценарии?
- Описана ли логика поведения интерфейса на макетах?
- Правильно ли расставлены акценты на экранах?
- Готовы ли все тексты и картинки?

Если в процессе работы над задачей на любом этапе ты решаешь отложить часть функционала, зафиксируй это в задаче.

Готовый дизайн можно презентовать команде и отдавать в разработку.

Во время разработки могут всплыть ещё какие-то вопросы. Обычно разработчики сами решают их с дизайнером.

### Задание

Выбери все ситуации, в которых продакт-менеджер хорошо организовал взаимодействие с дизайнером.
- Запланировал еженедельные встречи один на один **(+)**
- Настаивал на выборе конкретных визуальных решений
Дизайнер почти наверняка обладает более глубокой экспертизой в проработке пользовательского опыта. Продакту не стоит придумывать решения за дизайнера и загонять его в узкие рамки. **(-)**
- Хвалил и подбадривал при обсуждении черновой версии дизайна **(+)**
- Позвал дизайнера на встречу, где макет обсуждался с разработкой **(+)**
- Дал в работу три задачи с одинаковым приоритетом
Дизайнер не может делать три задачи одновременно. Продакту лучше сразу явно расставить приоритеты, даже если задачи кажутся примерно равными между собой. Если дизайнер будет сам решать, что и в каком порядке делать, это может не совпасть с ожиданиями продакта и привести к конфликту.

Тема «Дизайн и прототипирование» подошла к концу. В ней мы познакомились с основными принципами дизайна продукта, UX- и UI-дизайном, а также проектированием пользовательского опыта.
Мы изучили, какие бывают виды прототипов и инструменты для их создания. Также мы узнали, как продакту выстроить работу с дизайнером.
