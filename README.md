...
В поиске производственный заказ – далее кликаем по строке двойной клик после 
...
В зависимости от параметров заготовки считаем по калькулятору удельный вес в метрах (1м для прутков), для плит на одну заготовку (то есть на какой плите порезаны заготовки ) по размерам плиты.

![рис_52 ](./md_img/рис_52.png)
...
Если например пруток – м.п Д16 ф10 L=160 (7дет) – мы пишем заготовки количество на эту длину в карточке материала -  типо 0,16 – 7 шт.

Учитывать ширину реза при расчёте нормы расхода при вписание в
