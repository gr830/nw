...
**При создании карточки обязательно вносим Тц расчетное , подстовляем это в каждом альтернативном станке **
...
**! Первое изменения времени после создание тех. карты также вноситься в мастер данных**

**! Если известно периодичность контроля и параметры контроля то также добовляем в мастер данных**
...
!!!Важно если уже существует карточка c необходимым размером и материалом то не создаем новую а просто используем ее, а в параметрах ставим уже размер заготовки текущего товара и ее количество. Размер заготовки и количество не подтягиваеться глобально к карточке а индивидуально на текщий заказ.
...
Также можем указывать межосевое растояние таким способом если много значений
...
Также добовляем в карточку в поле production - килограммы
...
- После распечатываем чертежи на эти детали указанные в карте разрешения и помечаем маркером указанные несоответсвие на чертеже. Это для удобство при подписи в дальнейшем у конструктора в организации.

Необходмые подписи и т.д. у клиента:
...
- После главного конструктора (спросить кто в текущий момент отвественный)
...
!Не всегда атуальные данные подтягивает
